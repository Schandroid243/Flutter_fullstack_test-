...
import 'package:fullstack_exemple_flutter/pages/person_card.dart';
...
class HomePageState extends State<HomePage> {
  ...
  AppBar get appBar {
    return AppBar(
      title: const Text('Full Stack Exemple'),
      centerTitle: true,
    );
  }
  ...
  Future<void> saveAction() async {
    if (condition) {
      ...
      bool c = await network.check(p);
      if (c) {
        await network.write(p);
        await dialog(
  ...
  Future<void> dialog(String message) async {
